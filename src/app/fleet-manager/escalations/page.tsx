...
import { FleetManagerEscalationsClient } from "./escalations-client";

export default async function FleetManagerEscalationsPage() {
  ...
  return (
    <FleetManagerEscalationsClient userEmail={auth.userEmail} userDisplayName={auth.userDisplayName} />
  );
}
