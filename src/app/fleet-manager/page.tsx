...
import { FleetManagerHomeClient } from "./home-client";

export default async function FleetManagerRootPage() {
  ...
  return (
    <FleetManagerHomeClient userEmail={auth.userEmail} userDisplayName={auth.userDisplayName} />
  );
}
